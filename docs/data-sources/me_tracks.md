...
### Nested Schema for `items.track.album.artists`

Read-Only:

- `external_urls` (Attributes) Known external URLs for this artist. (see [below for nested schema](#nestedatt--items--track--album--artists--external_urls))
...
<a id="nestedatt--items--track--album--artists--external_urls"></a>
### Nested Schema for `items.track.album.artists.external_urls`
...
### Nested Schema for `items.track.album.external_urls`
...
### Nested Schema for `items.track.album.images`
...
### Nested Schema for `items.track.album.restrictions`
...
### Nested Schema for `items.track.artists.external_urls`
...
### Nested Schema for `items.track.linked_from.external_urls`
