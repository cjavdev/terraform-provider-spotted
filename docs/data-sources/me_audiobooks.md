...
### Nested Schema for `items.audiobook.chapters.items`
...
- `external_urls` (Attributes) External URLs for this chapter. (see [below for nested schema](#nestedatt--items--audiobook--chapters--items--external_urls))
...
- `images` (Attributes List) The cover art for the chapter in various sizes, widest first. (see [below for nested schema](#nestedatt--items--audiobook--chapters--items--images))
...
- `restrictions` (Attributes) Included in the response when a content restriction is applied. (see [below for nested schema](#nestedatt--items--audiobook--chapters--items--restrictions))
- `resume_point` (Attributes) The user's most recent position in the chapter. Set if the supplied access token is a user token and has the scope 'user-read-playback-position'. (see [below for nested schema](#nestedatt--items--audiobook--chapters--items--resume_point))
- `type` (String) The object type.
Available values: "episode".
- `uri` (String) The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the chapter.

<a id="nestedatt--items--audiobook--chapters--items--external_urls"></a>
### Nested Schema for `items.audiobook.chapters.items.external_urls`
...
<a id="nestedatt--items--audiobook--chapters--items--images"></a>
### Nested Schema for `items.audiobook.chapters.items.images`
...
<a id="nestedatt--items--audiobook--chapters--items--restrictions"></a>
### Nested Schema for `items.audiobook.chapters.items.restrictions`
...
<a id="nestedatt--items--audiobook--chapters--items--resume_point"></a>
### Nested Schema for `items.audiobook.chapters.items.resume_point`
