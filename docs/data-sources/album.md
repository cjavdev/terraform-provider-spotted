...
page_title: "spotted_album Data Source - Spotted"
subcategory: ""
description: |-
  
---

# spotted_album (Data Source)
...
```terraform
data "spotted_album" "example_album" {
...
- `tracks` (Attributes) The tracks of the album. (see [below for nested schema](#nestedatt--tracks))
...
- `external_urls` (Attributes) External URLs for this track. (see [below for nested schema](#nestedatt--tracks--items--external_urls))
...
### Nested Schema for `tracks.items.artists.external_urls`
...
### Nested Schema for `tracks.items.linked_from.external_urls`
