...
var _ datasource.DataSourceWithConfigure = (*TrackDataSource)(nil)

func NewTrackDataSource() datasource.DataSource {
	return &TrackDataSource{}
}

func (d *TrackDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_track"
}

func (d *TrackDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
