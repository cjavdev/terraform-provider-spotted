...
type UserPlaylistModel struct {
	...
	PathsRequestBodyContentApplicationJsonSchemaPropertiesPublished types.Bool                                              `tfsdk:"paths_request_body_content_application_json_schema_properties_published" json:"$.paths['*'].*.requestBody.content['application/json'].schema.properties.published,optional"`
